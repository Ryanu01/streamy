...
export const YtVideoPlayer = () => {
    return <section className="lg:col-span-7 border-r border-white/10 p-8 flex flex-col justify-center bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-white/[0.02] to-transparent">
          <div className="relative mx-auto w-full max-w-2xl group">
            ...
            <Card className="rounded-none bg-black border-white/10 overflow-hidden relative shadow-2xl shadow-[#CCFF00]/5">
              ...
              {/* Player Controls (Audio Only Focus) */}
              <div className="p-6 bg-[#111] border-t border-white/10">
                <div className="mb-4">
                  <h2 className="text-2xl font-black tracking-tight uppercase tracking-widest text-[#CCFF00]">
                    STAINLESS TIES
                  </h2>
